...
_lr_signature = 'ASSIGN DIVIDE LPAREN MINUS NUMBER PLUS RPAREN SEMICOLON TIMES VARIABLEexpression : expression PLUS termexpression : expression MINUS termexpression : termterm : term TIMES factorterm : term DIVIDE factorterm : factorfactor : NUMBERfactor : LPAREN expression RPAREN'
